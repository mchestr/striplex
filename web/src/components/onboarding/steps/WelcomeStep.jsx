...
const WelcomeStep = ({ onNext, serverInfo, nextStepName }) => {
  ...
  const getFeatureList = () => {
    ...
    if (serverInfo.requestsUrl) {
      features.push(<li key="requests">How to request new movies and TV shows</li>);
    }
  ...
  return (
    <div className="space-y-6">
      <div className="bg-green-500/20 border border-green-500/50 text-green-200 p-4 rounded-lg">
        <h2 className="text-xl font-bold mb-2">Welcome to {serverInfo.serverName}!</h2>
        <p>Congratulations! Your access has been granted. Let's get you set up with everything you need.</p>
      </div>
